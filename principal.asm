...
& _XT_OSC & _LVP_OFF
;CONFIGURA LVP_OFF MUITO IMPORTANTE ,
POIS, USO PORTB COMO I/O
CBLOCK 0x20
AUX_1
AUX_2
POS_MENU
...
MOVLW 0x00
MOVWF MENU_CONDICAO
INCF POS_MENU,0;INCREMENTA E SALVA EM
WORK
MOVWF POS_MENU;SALVA O WORK EM
POS_MENU
CALL TABELA_MENU;SEGUNDO NA PILHA
MOVWF MENU_CONDICAO
BTFSC MENU_CONDICAO,0;AS CONDICOES
SAO CHAMADAS COM GOTO POIS ASSIM NAO
CORRE RISCO DE OVERFLOW NO STACK
GOTO SALA
...
TABELA_MENU
ADDWF PCL,1
;PCL DEVE TER O NUMERO DO PROGRAM
COUNTER,E ADD O VALOR DE WORK NO PCL
...
MOVLW .5
CALL DL1S
MOVLW b'00001100';DISPLAY ON TA ERRADO NO
DATASHEET FICAR ATENTO
MOVWF LCD
CALL PULSO
MOVLW .5
CALL DL1S
